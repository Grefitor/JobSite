...
<head>
  ...
  <title><?php echo COMPANY; ?> - Register</title>
...
<div class="content">
  ...
  <div class="pageHead">
    Register with <?php echo COMPANY; ?> 
  </div>
  ...
  <div>
    <form action="./process/processRegister.php" method="post" onsubmit="return checkRegisterForm(this);">
      <table>
        <tr>
